...
workspace/
    documents/
        downloads/              # Raw paper PDFs from publishers or repositories
        renamed/                # Canonical paper filenames for reference corpora
        processed/              # OCR/extracted text and intermediate artifacts
        manifests/              # Track IDs, ingestion logs, and scan status
    notes/
        literature/             # Reading notes and citation summaries
        experiments/            # Hypotheses, observations, and failure analysis
    writing/
        outlines/                # Paper outlines and section plans
        drafts/                  # Draft sections and full-paper revisions
        figures/                 # Source figures and figure notes
        tables/                  # Table drafts and result summaries
  experiments/
  ...
  paper/
    ...
    bibliography/
        references.bib            # Canonical bibliography for the project
```
