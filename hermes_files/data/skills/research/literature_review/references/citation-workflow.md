...
**Recommendation**: Use natbib with BibTeX for conference submissions — all major venue templates ship with natbib and `.bst` files. BibLaTeX with Biber is an option for journals or personal projects where you control the template.
